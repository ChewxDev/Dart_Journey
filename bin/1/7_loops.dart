...
//* continue keyword
  for (var i = 1; i <= 10; i++) {
    //skip even numbers
    if (i ~/ 2 == 0) {
      continue; //To skip to the next value when the previous condition is met
    }
    print('$i \n');
  }

  //While loops are used when the we don't know when the iteration is meant to stop, but for loops are used when we are certain of the stopping point
